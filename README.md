...
| Artifact                                               | Purpose |
|--------------------------------------------------------|---|
| `io.github.refux:slang-java:0.0.4`                     | The library: compiler API, reflection, Java file systems |
| `io.github.refux:slang-java-natives:0.0.4:<os>-<arch>` | The official Slang binaries, as one classifier per platform: `windows`, `linux`, or `macos` × `x86_64` or `aarch64` |
...
dependencies {
    implementation("io.github.refux:slang-java:0.0.4")
    runtimeOnly("io.github.refux:slang-java-natives:0.0.4:$slangNatives")
}
...
dependencies {
    implementation("io.github.refux:slang-java:0.0.4")
    runtimeOnly("io.github.refux:slang-java-natives:0.0.4:macos-aarch64")
    runtimeOnly("io.github.refux:slang-java-natives:0.0.4:windows-x86_64")
    runtimeOnly("io.github.refux:slang-java-natives:0.0.4:linux-x86_64")
}
```
